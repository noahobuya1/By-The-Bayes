...
#### Part Two - Rudimentary Exponential Simulation accounting for a Que
...
#### Part Three - Fleshed Out Exponential Simulation accounting for a Que
...
simulate_day <- function(L) {
  ...
  daily_revenue <- hourly_revenue * (closing_hour - opening_hour)  # 12 operating hours from 10 am to 10 pm

  # Calculate daily wages for chefs
  daily_wages <- L * 40 * 12  # $40 per hour per chef
